...
(
	...
	datepart(year,lead_date)::int*100+datepart(month,lead_date)::int in (202103,202104)
),
...
(
	...
	days_past_due,
	dflt_status_dt,
	orig_loan_am from dm.experian_scrub_202103_202104
),
...
(
	...
	and datepart(year,date_time)::int*100+datepart(month,date_time)::int in (202103,202104)
),
