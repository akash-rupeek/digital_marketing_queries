TRUNCATE TABLE dm.dr_mid_low_funnel_old_attr;

INSERT INTO dm.dr_mid_low_funnel_old_attr 
...
leads as 
(select distinct unbounce_phone::varchar as unbounce_phone, lead_date from dm.dr_mapped_leads where lead_date >= '2020-01-01'),
