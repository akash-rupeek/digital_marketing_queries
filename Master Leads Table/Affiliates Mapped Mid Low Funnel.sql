TRUNCATE TABLE dm.affiliates_mid_low_funnel_temp;

INSERT INTO dm.affiliates_mid_low_funnel_temp

-- CREATE TABLE dm.affiliates_mid_low_funnel_temp AS
...
leads as 
(select distinct unbounce_phone::varchar as unbounce_phone, lead_date from dm.mapped_leads_test where lead_date >= '2020-01-01' and channel_source = 'Digital Affliate'),
...
min_txn_date AS 
(select mobile_num, min(date) as min_txn_date from growth.rpt_delivery_dashboard_v1 where lower(status) = 'completed' group by 1),
